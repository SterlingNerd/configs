#!/usr/bin/env bash
# run_onchange_install-shelly-packages.sh
# Re-runs whenever this file changes (e.g. when shelly-packages.txt is edited).
# Reads shelly-packages.txt and installs any missing packages via shelly.
